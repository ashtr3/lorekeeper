                ...
                @foreach ($bookmarks as $bookmark)
                    <tr>
                        ...
                        <td>
                            ...
                            {!! $bookmark->character->species_id ? $bookmark->character->species->displayName : 'No Species' !!} ・ {!! $bookmark->character->rarity_id ? $bookmark->character->rarity->displayName : 'No Rarity' !!} ・ {!! $bookmark->character->displayOwner !!}
