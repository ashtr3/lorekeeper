...
@section('content')
    ...
    <h5>
        @if (isset($comment->child_id))
            <a href="{{ route('browse.comment', $comment->child_id) }}" class="btn btn-secondary btn-sm mr-2">See Parent</a>
            <a href="{{ route('browse.comment', $comment->topComment->id) }}" class="btn btn-secondary btn-sm mr-2">Go To Top Comment</a>
        @endif
    </h5>
