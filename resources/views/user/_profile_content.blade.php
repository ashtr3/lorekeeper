    ...
    <div class="col">
        ...
        <div class="row no-gutters">
            <div class="col h2 text-center text-md-left">
                ...
                @endif
                <a href="{{ route('reports.create') . '?url=' . $user->url }}"><i class="fas fa-exclamation-triangle fa-xs text-danger" data-toggle="tooltip" title="Click here to report this user." style="opacity: 50%;"></i></a>
            </div>
