<script>
    $(document).ready(function() {
        ...
        $('.edit-genetics').on('click', function(e) {
            e.preventDefault();
            loadModal("{{ url($character->is_myo_slot ? 'admin/myo/' : 'admin/character/') }}/" + $(this).data('{{ $character->is_myo_slot ? 'id' : 'slug' }}') + "/genetics", 'Edit Character Genetics');
        });
