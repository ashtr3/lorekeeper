<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ route('designs.index') }}" class="{{ set_active('designs') }}">Drafts</a></div>
        <div class="sidebar-item"><a href="{{ route('designs.index', 'pending') }}" class="{{ set_active('designs/*') }}">Submissions</a></div>
    </li>
</ul>
