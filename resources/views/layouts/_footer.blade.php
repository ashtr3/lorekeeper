<nav class="navbar navbar-expand-md navbar-light">
    <ul class="navbar-nav ml-auto mr-auto">
        <li class="nav-item"><a href="{{ route('browse.page', 'about') }}" class="nav-link">About</a></li>
        <li class="nav-item"><a href="{{ route('browse.page', 'terms') }}" class="nav-link">Terms</a></li>
        <li class="nav-item"><a href="{{ route('browse.page', 'privacy') }}" class="nav-link">Privacy</a></li>
        <li class="nav-item"><a href="{{ route('browse.reports.bugs') }}" class="nav-link">Bug Reports</a></li>
        ...
        <li class="nav-item"><a href="{{ route('browse.credits') }}" class="nav-link">Credits</a></li>
