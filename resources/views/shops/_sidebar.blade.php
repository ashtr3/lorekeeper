<ul>
    <li class="sidebar-header"><a href="{{ route('browse.shops.index') }}" class="card-link">Shops</a></li>

    @if (Auth::check())
        <li class="sidebar-section">
            <div class="sidebar-section-header">History</div>
            <div class="sidebar-item"><a href="{{ route('shops.history') }}" class="{{ set_active('shops/history') }}">My Purchase History</a></div>
