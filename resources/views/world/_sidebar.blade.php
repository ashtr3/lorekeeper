<ul>
    ...
    <li class="sidebar-section">
        ...
        <div class="sidebar-item"><a href="{{ url('world/trait-loci') }}" class="{{ set_active('world/trait-loci*') }}">Trait Loci</a></div>
        <div class="sidebar-item"><a href="{{ url('world/trait-alleles') }}" class="{{ set_active('world/trait-alleles*') }}">Trait Alleles</a></div>
