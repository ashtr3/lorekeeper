    ...
    <div class="col-md-6">
        <div class="card mb-4">
            <div class="card-body text-center">
                <img src="{{ Storage::url('images/account.png') }}" alt="Account" />
...
<div class="row">
    <div class="col-md-6">
        <div class="card mb-4">
            <div class="card-body text-center">
                <img src="{{ Storage::url('images/inventory.png') }}" alt="Inventory" />
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body text-center">
                <img src="{{ Storage::url('images/currency.png') }}" alt="Bank" />
