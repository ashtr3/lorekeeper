...
@section('admin-content')
    @if ($submission->prompt_id)
        {!! breadcrumbs(['Admin Panel' => route('admin.index'), 'Prompt Queue' => route('admin.submissions.index.status', 'pending'), 'Submission (#' . $submission->id . ')' => $submission->viewUrl]) !!}
    @else
        {!! breadcrumbs(['Admin Panel' => route('admin.index'), 'Claim Queue' => route('admin.claims.index.status', 'pending'), 'Claim (#' . $submission->id . ')' => $submission->viewUrl]) !!}
    @endif
