...
@section('admin-content')
    {!! breadcrumbs(['Admin Panel' => route('admin.index'), 'Currencies' => route('admin.data.currencies.index')]) !!}
    ...
    <p>The order of currencies as displayed on user and character profiles can be edited from the <strong><a href="{{ route('admin.data.currencies.sort') }}">Sort Currencies</a></strong> page.</p>

    <div class="text-right mb-3"><a class="btn btn-primary" href="{{ route('admin.data.currencies.create') }}"><i class="fas fa-plus"></i> Create New Currency</a></div>
    {!! $currencies->render() !!}
                ...
                <div class="logs-table-row">
                    <div class="row flex-wrap">
                        ...
                        <div class="col-4 col-md-1">
                            <div class="logs-table-cell"><a href="{{ route('admin.data.currencies.edit', $currency->id) }}" class="btn btn-primary">Edit</a></div>
                        </div>
                    </div>
                </div>
            @endforeach
