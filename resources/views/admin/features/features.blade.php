...
@section('admin-content')
    {!! breadcrumbs(['Admin Panel' => route('admin.index'), 'Traits' => route('admin.data.traits.index')]) !!}
    ...
    <div class="text-right mb-3">
        <a class="btn btn-primary" href="{{ route('admin.data.trait-categories.index') }}"><i class="fas fa-folder"></i> Trait Categories</a>
        <a class="btn btn-primary" href="{{ route('admin.data.traits.create') }}"><i class="fas fa-plus"></i> Create New Trait</a>
    </div>
                    ...
                    <div class="logs-table-row">
                        <div class="row flex-wrap">
                            ...
                            <div class="col-12 col-md-1">
                                <div class="logs-table-cell"><a href="{{ route('admin.data.traits.edit', $feature->id) }}" class="btn btn-primary py-0 px-1 w-100">Edit</a></div>
                            </div>
                        </div>
                    </div>
                @endforeach
